        ...
        <div>
          <div className={classes.container}>
            ...
            <div className={classes.description}>
              ...
              <br/>
              <br/>
              After having spent several years as a forecasting analyst, I realized that I needed to pursue a field that involved more creativity and allowed for constant learning. While it may be overwhelming to think about how many technologies exist, I love the fact that I have an abundance of resources to learn anything I wish, in order to further develop the skills I've gained. My experience as an analyst mixed with my knowledge derived from the seven years spent in customer service, makes me a valuable asset because, my inquisitiveness lends itself to excellent communication and drive.{" "}
              </p>
